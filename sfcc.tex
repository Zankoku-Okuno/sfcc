...
Our key insight was that although existing FCC systems are able to effect non-local control flow, they lack the ability to intercept non-local control flow.
We work out the details of $\lambda_{SFCC}$ by referring to existing literature with a view to encompass as many mechanisms as is reasonably possible.

The main advantage of $\lambda_{SFCC}$ is that it provides for deterministic resource initialization and cleanup, even in the presence of arbitrarily complex non-local control flow.
Beyond that, it turns out that $\lambda_{SFCC}$ can implement all major control operators without difficulty.
Compared with exception handling systems, an important advantage of $\lambda_{SFCC}$ is that it is formally specified.
Since $\lambda_{SFCC}$ is capable of implementing various exception handling mechanism, we immediately gain a formal specification of these control structures.
...
\textbf{and} &\equiv \x,y. {}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;\&\&\;k\;y \\
\textbf{or} &\equiv \x,y. {}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;||\;k\;y \\
\end{align*}
Of course, additional conjunctions might be implemented; we have limited ourselves to these two fro brevity.

Now that we have the definitions, we will give a short reduction sketch.
\begin{align*}
&\textbf{conj}\;(0 == 1\textbf{ or }2\textbf{ or }0) \\
\equiv{}\;\;& \#_\textbf c 0 ==
	(\x,y.{}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;||\;k\;y)
		\;((\x,y.{}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;||\;k\;y)
			\;1\;2)
		\;0 \\
%
\mapsto^*{}& \#_\textbf c 0 == {}^+\F^-_\textbf{c}\lambda \_, k.\,k\;((\x,y.{}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;||\;k\;y)
			\;1\;2)\;||\;k\;0\\
%
\mapsto^*{}& \angles{0==\square}\;((\x,y.{}^+\F^-_\textbf{c}\lambda \_, k.\,k\;x\;||\;k\;y)
			\;1\;2)\;||\;\angles{0==\square}\;0\\
%
\mapsto^*{}& 0==({}^+\F^-_\textbf{c}\lambda \_, k.\,k\;1\;||\;k\;2)
			\;||\;\angles{0==\square}\;0\\
%
\mapsto^*{}& \angles{0==\square}\;1\;||\;\angles{0==\square}\;2
			\;||\;\angles{0==\square}\;0\\
\equiv{}\;\;& 0==1\;||\;0==2\;||\;0==0\\
%
\mapsto^*{}& \textbf{true}
