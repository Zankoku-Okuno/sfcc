...
%\linespread{0.901} %that's a bit tight!
\raggedright
\setlength{\parindent}{2em}
...
With this feature, however, we also need specialized constructs, such as that in \S\ref{dynamic-wind} to intercept non-local control flow, since we can no long rely on any delimiter to intercept arbitrary non-local control flow.
