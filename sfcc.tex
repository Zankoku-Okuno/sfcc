...
The implementations here justify our description of extent guards in \ref{subsec:extentGuards}.
...
In Scheme, dynamic-wind a function which takes three zero-argument functions, rather than being a special form taking three subexpressions; this is the reason for the enclosing lambda in our implementation.
...
(give our previous operational semantics)
