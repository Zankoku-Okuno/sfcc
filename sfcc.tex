...
\usepackage[top=1.2in, bottom=1in, right=1in, left=1.5in]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\thepage}
...
Master of Science in Computer Science \\*[1in]
...
\hskip 2.5in Approved:\\

\vskip .33in
\hskip 2.5in ------------------------------------------------\\*
\hskip 2.5in Dr. Patrick Otoo Bobbie, Advisor

\vskip .33in
\hskip 2.5in ------------------------------------------------\\*
\hskip 2.5in Dr. Ken Hoganson, Interim Department Chair, \\*
\hskip 2.5in Computer Science Department

\vskip .33in
\hskip 2.5in ------------------------------------------------\\*
\hskip 2.5in Dr. E. K. Park, Dean, \\*
\hskip 2.5in College of Computing and Software Engineering
...
\noindent Unpublished theses deposited in the Library of Southern Polytechnic State University must be used only in accordance with the stipulations prescribed by the author in the preceding statement.

\noindent The author of this thesis is:\\*
\begin{center}
Eric Demko\\*
4113 Admiral Dr., Chamblee, GA \\*
demko137@gmail.com
\end{center}
...
\vspace*{2in}
\begin{center}
{\LARGE On Secure First-Class Control} \\*[2in]
An Abstract of \\*
A Thesis Presented to \\*
The Faculty of the Computer Science Department \\*[.33in]
by \\*[0.167in]
Eric Demko\\*
Bachelor of Science in Physics, Oglethorpe University, 2011 \\*[.33in]
In Partial Fulfillment \\*
of Requirements for the Degree \\*
Master of Science in Computer Science \\*[1in]
Southern Polytechnic State University\\*
...
%The main purpose of this thesis is to develop a formal semantics with which language designers can reasonably integrate first-class control into production programming languages.
...
%The goal of this thesis is find a formulation of FCC that significantly reduces the likelihood of programmer error without sacrificing its expressive power.
...
In this thesis, we develop the semantics of an extended lambda calculus incorporating secure, expressive, and convenient first-class control.
Our formulation unifies continuations with other non-local control constructs, especially including exceptions.
...
%For such endeavor lifts the individual within the mass and raises him out of the depths of ignorance to the highest reaches of knowledge and human excellence.

\newpage
\section*{Acknowledgements}

%thesis committee, insightful reccomendations
...
%parents for supporting my intellectual pursuits, esp. dad for introducing me to programming at a young age
...
%several of my various teachers who, even though they may not have knowledge of this work, provided me with the many keys required to unlock my capacity for mathematical thinking (Milne, Hunt?, Tiu, Karam)
...
%Without control operators, the context strictly obeys a stack discipline, but once we are allowed to capture portions of the stack as values, we can then apply the full power of lambda calculus to control the evaluator's dynamic extent at runtime (\textit{i.e.} possibly in response to input).
...
%The language designer should be sensitive to the burdens of the programmer, not to his own.
...
% where multiple prompts alone cannot guarantee setup or cleanup when a dynamic extent is entered/exited, the addition of dynamic-wind gives us this capability
...
%%  2) directly (\textit{i.e.} inline) install deterministic handlers (\textit{e.g.} catch-clauses),
...
%$$\nu \mapsto p \quad\textrm{where $p$ is fresh}$$
